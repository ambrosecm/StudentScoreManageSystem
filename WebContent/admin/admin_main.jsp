...
<link rel="stylesheet" type="text/css" href="/StudentScoreManageSystem/dist/css/main.css" />
...
<body class="easyui-layout" id="b1">
	...
	<div region="north" class="header" >
		<img alt="logo" src="/StudentScoreManageSystem/dist/images/logo1.PNG" >
	</div>
	<div region="west" class="left" title="教务管理系统">
		<div class="left-list">
			<div class="left-list-item" url="/StudentScoreManageSystem/admin/tab_student.jsp" title="学生管理">
			...
			<div class="left-list-item" url="/StudentScoreManageSystem/admin/tab_teacher.jsp" title="教师管理">
			...
			<div class="left-list-item" url="/StudentScoreManageSystem/admin/tab_course.jsp" title="学生选课管理">
				<a class="easyui-linkbutton" iconCls="icon-teaching" plain="true">学生选课管理</a>
				<!-- <img alt="" src="dist/css/icons/score.png" width="14px" height="14px" ><span>授课管理</span> -->
			</div>
			<div class="left-list-item" url="/StudentScoreManageSystem/admin/tab_score.jsp" title="学生成绩管理">
				<a class="easyui-linkbutton" iconCls="icon-score" plain="true">学生成绩管理</a>
	...
	<div region="center" class="right">
		<div  id="tab" fit="true" >
			<div title="主页" iconCls="icon-home" style="font-size:22px">
